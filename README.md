...
| `VITE_FIREBASE_*` | Firebase web client configuration for the extension |
...
4. Run backend locally with `pnpm --filter @context-passport/backend dev`.
...
4. Select [extension/dist](/C:/Users/MSI/OneDrive/Desktop/Universal%20AI%20session%20handoff%20system/extension/dist).
5. Copy the generated extension ID into `.env` as `EXTENSION_CHROME_ID` for strict CORS in production.
...
- [ci.yml](/C:/Users/MSI/OneDrive/Desktop/Universal%20AI%20session%20handoff%20system/.github/workflows/ci.yml) runs lint, typecheck, tests, and build on every push and PR.
- [deploy-backend.yml](/C:/Users/MSI/OneDrive/Desktop/Universal%20AI%20session%20handoff%20system/.github/workflows/deploy-backend.yml) deploys the backend to Vercel on `main`.
- [deploy-extension.yml](/C:/Users/MSI/OneDrive/Desktop/Universal%20AI%20session%20handoff%20system/.github/workflows/deploy-extension.yml) builds the extension zip and publishes `v1.0.0`.
